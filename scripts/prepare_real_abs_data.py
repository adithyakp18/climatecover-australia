...
def prepare_census_sa2() -> None:
    url = find_download_url(CENSUS_DATAPACK_PAGE, "2021Census_GCP_SA2_for_AUS")
    zip_path = DOWNLOAD_DIR / "2021Census_GCP_SA2_for_AUST.zip"
...
def main() -> int:
    ...
    try:
        ...
        logger.warning("Writing SEIFA-derived proxy demographics instead.")
